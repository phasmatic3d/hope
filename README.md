...
<p>
  ...
  <em>Figure 1: Producer–consumer pipeline for robust, realtime context-aware holographic streaming. RGB-
...
highlighted with pink color while client-side with green color.</em>
</p>

<p>
  <img src="images/pipeline.jpg" alt="HOPE pipeline diagram"><br>
  <em>Figure 2: The proposed pipeline consists of server-side modules (left) and client-side modules (right). On
...
rasterizer for real-time rendering.</em>
</p>
...
This research received funding from the European Union under the SPIRIT
project (Grant Agreement No. 101070672). Specifically, it was supported through a
Financial Support to Third Parties (FSTP, cascading funding) project, HOPE, under
Subgrant Agreement No. 37573. More information on the HOPE project is available
at [this link](https://www.phasmatic.com/research_hope.html).

## License

The core of this project is licensed under the MIT License - see the [LICENSE](LICENSE) file for details.

### Third-Party Licenses 

This project relies on several third-party packages, which are governed by their own respective licenses:

* **[SAM2](https://github.com/facebookresearch/sam2)** - Licensed under the [Apache 2.0 & BSD-3-Clause](https://github.com/facebookresearch/sam2/blob/main/LICENSE)
* **[Mediapipe](https://github.com/google-ai-edge/mediapipe/tree/master)** - Licensed under the [Apache 2.0](https://github.com/google-ai-edge/mediapipe/blob/master/LICENSE)
* **[Realsense](https://github.com/realsenseai/librealsense)** - Licensed under the [Apache 2.0](https://github.com/realsenseai/librealsense/blob/master/LICENSE)

## Citing Context-Aware Point Cloud Streaming for High-Fidelity Holographic Telepresence
If you use this paper in your research projects or application (or the original work from [HOPE](https://www.phasmatic.com/research_hope.html)), please use the following BibTex entries:

### Main Paper
`[TODO: PUT PAPER CITATION HERE]`

### [HOPE Poster](https://www.phasmatic.com/research_hope.html):
