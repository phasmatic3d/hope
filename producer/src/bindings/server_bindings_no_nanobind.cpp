...
public:
    ...
    use_pings_for_rtt(use_pings_for_rtt)
    {
        ...
        (
            [this](websocketpp::connection_hdl h) -> websocketpp::lib::shared_ptr<websocketpp::lib::asio::ssl::context>
            {
                ...
                websocketpp::lib::shared_ptr<websocketpp::lib::asio::ssl::context> ctx = std::make_shared<asio::ssl::context>(asio::ssl::context::tlsv12);
    ...
    void broadcast(const uint8_t* data, size_t message_size)
    {
