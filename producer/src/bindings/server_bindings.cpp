...
public:
    ...
    size_t broadcast(const nb::bytes &data)
    {
        ...
        if(!write_to_csv) return broadcast_round;
        ...
        return broadcast_round; // <-- we'll use this for python side synchronization when getting the csv 
    }
...
private:
    ...
    void startLoggingThread()
    {
        ...
        const std::string path = "./stats/send_times.csv";
